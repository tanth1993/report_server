...
router.use('/get-students-by-query', StudentController_1.default.getStudentsByQuery);
router.use('/get-student-detail/:id', StudentController_1.default.getStudentDetail);
router.use('/get-score-student/:studentId/:gradeId', StudentController_1.default.getStudentScoreByGrade);
